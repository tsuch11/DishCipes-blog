						...
						<article>
							...
							<div>
								...
								<textarea
									...
									rows={3}
									className="w-full px-4 py-3 text-sm text-brown-600 bg-white border border-brown-200 rounded-xl outline-none placeholder:text-brown-300 focus:border-brown-400 transition-colors duration-150 mb-3"
								/>
