				...
				<div className="max-w-7xl mx-auto px-4 py-8 md:px-10 md:py-12">
					<div className="flex flex-col gap-8 md:flex-row md:gap-16">
						<aside className="shrink-0 md:w-52">
							<ProfileSidebar user={user} section="Profile" />
						</aside>
							...
							<div className="bg-brown-200 rounded-2xl p-6 md:p-8">
								<form onSubmit={handleSave} className="flex flex-col gap-6">
									<div className="flex items-center gap-5 pb-5 border-b border-brown-300">
										<div className="w-20 h-20 rounded-full overflow-hidden bg-brown-300 shrink-0">
											{avatar ? (
										...
										<div>
											...
											<button
												...
												className="px-5 py-2 text-sm font-medium text-brown-600 bg-white border border-brown-400 rounded-full hover:bg-brown-100 transition-colors duration-150"
											>
									...
									<div className="flex flex-col gap-1.5">
										...
										<input
											...
											className="w-full px-4 py-3 text-sm text-brown-600 bg-white border-2 border-transparent rounded-xl outline-none placeholder:text-brown-300 focus:ring-2 focus:ring-brown-300 transition-all duration-150"
										/>
									</div>
									...
									<div className="flex flex-col gap-1.5">
										...
										<p className="px-4 py-3 text-sm text-brown-300">{user.email}</p>
									</div>
