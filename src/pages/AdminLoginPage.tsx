...
const AdminLoginPage = () => {
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-stone-50 px-4 font-sans animate-fadeInUp">
				...
				<form onSubmit={handleSubmit} className="flex flex-col gap-5">
					...
					<div className="flex justify-center mt-2">
						<button
							type="submit"
							disabled={loading}
							className="px-12 py-3 text-sm font-medium text-white bg-stone-800 rounded-full hover:bg-stone-700 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150"
						>
			...
			{error && (
				<div className="fixed bottom-6 right-6 flex items-start gap-3 bg-[#E8545A] text-white px-5 py-4 rounded-2xl shadow-lg z-50 max-w-xs animate-slideDown">
